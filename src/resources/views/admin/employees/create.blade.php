    ...
    <div class="page-heading">
        <div class="page-heading-copy">
            ...
            <div>
                ...
                <h1 class="h3 mb-1">Tambah Karyawan</h1>
                <p class="text-muted mb-0">Akun login karyawan akan dibuat otomatis dengan role "karyawan".</p>
            </div>
        </div>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control @error('position') is-invalid @enderror" id="position" name="position"
                        type="text" value="{{ old('position') }}" placeholder="mis. Staff Lingkungan">
                    @error('position')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
